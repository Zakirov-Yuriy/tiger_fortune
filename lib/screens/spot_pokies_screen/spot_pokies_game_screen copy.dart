...
import '../spot_slot_screen/you_win_slot_screen.dart';
import 'you_win_pokies_screen copy.dart';

class SpotPokiesGameScreen extends StatelessWidget {
  @override
        ...
        children: [
          ...
          PlusMinusPositioned(
            onPlusPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => YouWinPokiesScreen()),
              );
            },
            onMinusPressed: () {
              Navigator.push(

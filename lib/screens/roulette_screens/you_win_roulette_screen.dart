...
import 'package:tiger_fortune/screens/roulette_screens/roulette_screen.dart';

import '../../widgets/spot_roulette_widgets/custom_title_widget2.dart';
import '../pause/pause_screens.dart';

class YouWinRouletteScreen extends StatelessWidget {
  @override
      ...
      body: Stack(
        children: [
          ...
          const Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(top: 116.0, left: 118),
              child: CustomTitle2(
                text: 'Spot\nRoulette',
              ),
            ),
          ...
          Positioned(
            ...
            left: 118.45,
            child: Image.asset(
              'assets/images/spot_roulette/Roulettefuul.png',
              width: 137.15,
              height: 140,
            ),
          ),
